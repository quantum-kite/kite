...
:   **Attributes**
    :   | Attribute                                                                                      | Description                                 |
        ...
        | <span id="modification-atr-flux">`#!python flux`:*`#!python float`*</span>                     | The added magnetic flux to the lattice.     |
...
:   **Parameters**
    ...
    : <span id="configuration-angles">`#!python angles`: *`#!python float` or `#!python tuple(float, float)` or `#!python tuple(float, float, float)`*</span>
        : The angles used for the twisted boundary conditions when `#!python boundary="twist"` is selected.
          The values of `#!python angle`must be in the interval *[0, M \* 2 \pi]*.
        ...
        :   Calculate the DC conductivity for a given direction.
            ...
            **Parameters**
            ...
            :   | Parameter                                 | Description                                                                                                                                                                                                                                                                                                               |
                ...
                | `#!python num_random`:*`#!python int`*    | Number of random vectors to use for the stochastic evaluation of trace.                                                                                                                                                                                                                                                   |
                | `#!python num_disorder`:*`#!python int`*  | Number of different disorder realisations.                                                                                                                                                                                                                                                                                |
                | `#!python temperature`:*`#!python float`* | Value of the temperature at which we calculate the response. If *eV* is used as unit for energy, the termperature is given in Kelvin. Internally, this temperature is converted using Boltzmann's constant *Kb*. To define the temperature in arbitraty units, specify the quantity *Kb \* T*, which has units of energy. |
...
[tutorial-hdf5]: ../tutorial/editing_hdf_files.md