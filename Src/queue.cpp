...
measurement_queue :: measurement_queue(std::string dir_string, std::vector<int> moments, int disorder, int random, std::string name){
...
void measurement_queue::embed_time(double avg_duration){
  int prod = 1;
...
void singleshot_measurement_queue::embed_time(double avg_duration){
  time_length = 0;
...
singleshot_measurement_queue::singleshot_measurement_queue(std::string dir_string, Eigen::Array<int, -1, 1> moments, int disorder, 
