...
def graphene_initial(onsite=(0, 0)):
    ...
    struc_disorder_one = ex.StructuralDisorder(lat, concentration=0.035)
...
calculation = ex.Calculation(fname=['DOS', 'CondXX'], num_moments=[128, 24], num_random=[1, 1], num_disorder=[1, 1])
